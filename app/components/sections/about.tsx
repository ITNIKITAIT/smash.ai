      ...
      <div className="container px-4 mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <motion.div
            ...
            viewport={{ once: true }}>
            <h2 className="text-3xl md:text-5xl font-bold mb-6">About SMASH</h2>
            ...
            <div className="space-y-6 text-lg text-muted-foreground mb-8">
              <p>
                The global streaming economy is a{' '}
                <strong>$180B opportunity</strong>. Yet, consumers who fuel this
                demand receive $0, and artists fight for fractions of a penny.
              </p>
              <p>
                SMASH AI STREAMING changes the game. We pay listeners 3% of
                gross programmatic ad revenue and an additional 2% for direct
                referrals.
              </p>
            </div>
            ...
            <div className="relative z-10 grid gap-6">
              ...
              <div className="bg-card border border-white/10 p-8 rounded-2xl relative overflow-hidden group hover:border-primary/50 transition-colors">
                ...
                <p className="text-muted-foreground mb-4">
                  Earn crypto for every minute you listen and every friend you
                  refer.
                </p>
              ...
              <div className="bg-card border border-white/10 p-8 rounded-2xl relative overflow-hidden group hover:border-secondary/50 transition-colors ml-8">
                ...
                <p className="text-muted-foreground mb-4">
                  Get paid 33x more than Spotify with instant, transparent
                  payouts.
                </p>
